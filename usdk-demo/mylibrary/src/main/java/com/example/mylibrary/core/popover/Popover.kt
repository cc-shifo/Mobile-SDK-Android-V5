package com.example.mylibrary.core.popover
...
import com.example.mylibrary.core.extension.getLandScreenSize
    ...
    class Builder(var anchor: View) {
        ...
        init {
            dropShadow = DropShadow(
                color = anchor.resources.getColor(R.color.uxsdk_black_20_percent,null),
                dx = 0F,

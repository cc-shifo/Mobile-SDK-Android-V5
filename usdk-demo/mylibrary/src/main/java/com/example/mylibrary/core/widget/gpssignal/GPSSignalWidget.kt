package com.example.mylibrary.core.widget.gpssignal
...
import com.example.mylibrary.accessory.RTKEnabledWidgetModel
    ...
    private fun getTintColor(level: GpsSignalWidgetModel.SignalLevel): Int {
        return when (level) {
            GpsSignalWidgetModel.SignalLevel.LEVEL_1 ->
                resources.getColor(R.color.uxsdk_tips_danger_in_dark, null)
            GpsSignalWidgetModel.SignalLevel.LEVEL_2 ->
                resources.getColor(R.color.uxsdk_tips_caution_in_dark, null)
            GpsSignalWidgetModel.SignalLevel.LEVEL_3 ->
                resources.getColor(R.color.uxsdk_tips_normal_in_dark, null)
        }
    }
}